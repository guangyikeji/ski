...
青少年运动员额外计算（U15组别）：
U15最终积分 = 54.58 × 0.70 (年龄系数) + 2.0 (进步奖励) = 40.21分
```
...
const YOUTH_AGE_COEFFICIENTS = {
  U21: { coefficient: 0.95, progressBonus: 1.0 },  // 21岁以下
  U18: { coefficient: 0.85, progressBonus: 1.5 },  // 18岁以下
  U15: { coefficient: 0.70, progressBonus: 2.0 },  // 15岁以下
  U12: { coefficient: 0.55, progressBonus: 2.5 },  // 12岁以下
  U10: { coefficient: 0.40, progressBonus: 3.0 }   // 10岁以下
};
